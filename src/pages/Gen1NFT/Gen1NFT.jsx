                                    ...
                                    <div className={Style.nft__textContainer}>
                                        ...
                                        {isWalletConnected ?
                                            <>
                                                    ...
                                                    <div className={Style.nft__mintContainerConnected}>
                                                        ...
                                                        <div className={Style.nft__mintTextContainerConnected}>
                                                            <div className={Style.nft__mintTextWrapperConnected}>
                                                                <p className={Style.nft__mintTextConnected}>Mint price: <span className={Style.nft__mintCost}>1 OxBull = 2.0 ETH</span></p>
                                                ...
                                                <p className={Style.nft__mintTextConnectedCount}>Mint price: <span className={Style.nft__mintSpanGreenConnected}>{(counter) * 2.0} ETH</span></p>
                                            ...
                                            <>
                                                ...
                                                <p className={Style.nft__mintText}>Mint price: <span className={Style.nft__mintSpan}>1 OxBull = 2.0 ETH</span></p>
