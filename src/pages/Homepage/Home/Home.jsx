    ...
    return (
        <section className={Style.home} id="home">
            <div className={Style.home__content}>
                ...
                <div className={Style.home__textcontainer} data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div className={Style.home__links}>
                        ...
                        <Link className={Style.home__linkyellow} to="https://t.me/OXMiner_news" target="_blank" >
                            <img class={Style.home__socialicon} src={Telegram} alt="Tg" />
                            Join Community
                        </Link>

                        <Link className={Style.home__linkgreen} to="/join-newsletter" onClick={scrollToTopInstant} >
